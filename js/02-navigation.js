...
const HELP_TEXT = {
  ...
  atendimentos: 'A semana dos atendimentos: escolha o dia na faixa e marque Veio ou Faltou com um clique (clicar de novo desfaz). Clique no nome para ver os detalhes, remarcar, excluir ou encerrar um atendimento semanal. No aluno ou no profissional você vê o histórico e a presença. Copiar semana anterior não repete o que já existe; o Relatório gera o PDF da semana, do mês ou de um período; a Lista de presença imprime a folha do dia (ou da semana) para o responsável assinar. Quando um aluno falta 3 vezes seguidas, aparece um aviso em Pendências e no painel do aluno — marque "Família contatada" depois de falar com a família.'
};
...
function goToView(view, opts){
  if (view === 'modelos') view = 'gerador'; // aba antiga, hoje dentro do Gerador
  if (!VIEW_META[view]) {
